...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
	<div class="container">
		<a class="navbar-brand" href="/turimosTierraMedia/index.jsp">Turismo en la Tierra Media</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<li class="nav-item"><a class="nav-link active"
				...
				<li class="nav-item"><a class="nav-link active"
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/turimosTierraMedia/users/index.do">Usuarios</a></li>
			...
			<ul class="navbar-nav">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end"
						...
						<li><a href="/turimosTierraMedia/logout" class="dropdown-item">Salir</a></li>
					</ul>
				</li>
			</ul>
		</div>
